...
addpath('/media/speech/Data/Files/Thesis_data/clean/15')
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
s=dir('/media/speech/Data/Files/Thesis_data/clean/15/*.flac');
...
for j=1:170;
    ...
    for i=1;
        ...
        t60=t(random_number);
        useGPU=0;
        RIR = genMultiChannelRIR_coprime(t60, useGPU,doa)';    % generate the room impulse responses
        [distorted, reverb_only] = ApplyConstRirNoise(wav_clean, fs, RIR, wav_noise, SNR, useGPU);
